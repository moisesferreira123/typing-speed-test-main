        ...
        <div className="min-w-130">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-linear-to-r from-(--blue-400) to-(--yellow-400) rounded-lg text-(--neutral-800)"><Trophy size={20} /></div>
              <div>
          ...
          {!loading && <RankTable leaderboard={leaderboard} />}
        </div>
      </div>
    </div>
  );
